...
import { copylinkToClipboard, getJbIdePrice } from "@/services/home.ts";
...
onMounted(async () => {
  ...
  jbPrice.value = await getJbIdePrice(emailStore.getEmail);
});

const buyCount = ref(1);
const totalMoney = computed(() => {
  return buyCount.value * jbPrice.value;
});
...
<template>
  <div class="product-page">
    <div class="left">
      ...
      <img src="../assets/jbide.jpg" alt="商品图片" class="product-image" />
    </div>

    <div class="right">
      <h2 class="product-title">JB全家桶破解</h2>
      <div class="price">
        商品单价：<span class="text-green-500">¥{{ jbPrice }}</span>
      </div>
      <div class="status">
